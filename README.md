...
## Tanzu Platform Operator/Engineering Tooling Setup

This repository contains a configurable, ready to go ansible playbook that can be used to install most cli tools required for operating Tanzu Platform, this includes om, fly, bosh, cf and more.

### Configuring the playbook

To configure the playbook for your WSL, you can examine and update the included `vars.yml`, this includes configurations for your WSL username, cli install location and more. For details on all the available configurations see `vars.yml`

### Running the playbook

Once you have updated the `vars.yml`, simply execute `./setup.sh`
